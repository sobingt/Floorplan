...
phonecatApp.controller('PhoneListCtrl', function ($scope) {
  $scope.items = [
    {'name': 'Floor1', 'top': 0, 'left': 0, 'height': 382, 'width': 336, 'color': '#ddd', 'zIndex': 1, 'group':'Floor'},
	{'name': 'Floor2', 'top': 44, 'left': 336, 'height': 338, 'width': 110, 'color': '#ddd', 'zIndex': 1, 'group':'Floor'},
	{'name': 'DoorSovrum', 'top': 154, 'left': 444, 'height': 80, 'width': 4, 'color': '#fff', 'zIndex': 2},
	{'name': 'DoorBalkong', 'top': 380, 'left': 300, 'height': 4, 'width': 80, 'color': '#fff', 'zIndex': 2},
	{'name': 'DoorHall', 'top': -2, 'left': 236, 'height': 4, 'width': 80, 'color': '#fff', 'zIndex': 2},
